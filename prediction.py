...
class RenewableEnergyModels:
    ...
    def _load_pickle(self, file_path):
        ...
        try:
            ...
            if "sklearn" in str(e) or "_gb_losses" in str(e):
                print("This appears to be a scikit-learn version compatibility issue.")
                print("The saved models were created with a different version of scikit-learn.")
                print("Please retrain the models by running: python model.py")
            return None
